class VehicleHandover {
  ...
  factory VehicleHandover.fromMap(Map<String, dynamic> map) {
    return VehicleHandover(
      ...
      vehicleGivenDate: (map['vehicleGivenDate'] ?? '').toString(),
      vehicleGivenTime: (map['vehicleGivenTime'] ?? '').toString(),
      vehicleReturnDate: (map['vehicleReturnDate'] ?? '').toString(),
      vehicleReturnTime: (map['vehicleReturnTime'] ?? '').toString(),
